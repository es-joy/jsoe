...
async function getSchemaContent (schema) {
  ...
  case 'Zodexy schema instance 13':
    return schemaInstanceJSON13;
  ...
  case 'Zodexy schema instance xor 3':
    return schemaInstanceJSONXor3;
